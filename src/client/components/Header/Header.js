  ...
  return (
    <header className={styles.header}>
      ...
      <WidthWrapper className={styles.barWrapper}>
        <button
          className={`${styles.mobileOpen} ${isOpen ? styles.hide : ''}`}
        ...
        <div className={styles.userBar}>
          <NavLinkCustom to="/profile/details">
      ...
      <nav className={`${styles.nav} ${isOpen ? styles.open : ''}`}>
        <WidthWrapper className={styles.navWrapper}>
          ...
          <NavLinkCustom to="/" onClick={() => setIsOpen(false)}>
            Home
          </NavLinkCustom>
          <NavLinkCustom to="/products/all" onClick={() => setIsOpen(false)}>
            All
          </NavLinkCustom>
