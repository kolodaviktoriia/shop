...
const AddressForm = ({ onSubmit }) => {
    ...
    const validate = () => {
        ...
        if (!formValues.houseNumber) newErrors.houseNumber = 'House number is required';
    ...
    return (
        <div className={styles.addressFormWrapper}>
            ...
            <form className={styles.addressForm} noValidate>
                ...
                <InputField label='Street' name='street' type='text' value={formValues.street} error={errors.street} onChange={handleChange} />
                <InputField label='House Number' name='houseNumber' type='text' value={formValues.houseNumber} error={errors.houseNumber} onChange={handleChange} />
                <InputField label='Postal Code' name='postalCode' type='text' value={formValues.postalCode} error={errors.postalCode} onChange={handleChange} />
